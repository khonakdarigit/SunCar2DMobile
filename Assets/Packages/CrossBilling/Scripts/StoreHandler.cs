...
{
    /// <summary>
    ///     Handles interactions with market IAB Java library and provides convenience methods for in-app billing.
    ...
    ///     Note that this information is sensitive and any mismatching with market developer's panel can cause problems.
    /// 
    ...
    ///     
    ///     After initialization is complete, you will typically want to request products prices from market. 
    ...
    {
        public enum StoreName {myket, cafebazaar, googleplay, zarinpal}
        ...
        public string MarketName { get => market; set => market = value; }
        ...
        /// <summary>
        /// User didn't install market application.
        /// </summary>
        public const int ERROR_MYKET_NOT_INSTALLED = 2;
        ...
        /// <summary>
        /// Internal error happened. Follow the instructions carefully and if it persists contact market developer support.
        /// </summary>
        ...
        /// <summary>
        /// User is not logged in to market application so can't check the inventory.
        /// </summary>
        ...
        /// </summary>
        public const int ERROR_NOT_SUPPORTED_IN_EDITOR = 9;

        /// <summary>
        /// Product index is not valid and doesn't exist in products[] array.
        /// </summary>
        public const int ERROR_WRONG_PRODUCT_INDEX = 10;

        /// <summary>
        /// Invalid Id exists in products[] array or no product is defined.
        /// </summary>
        public const int ERROR_WRONG_PRODUCT_ID = 11;
        ...
        private static readonly string utilsClass = "com.gerantech.crossbilling.CrossBilling";
        ...
        /// <summary>
        /// Initializes market billing service. If any problem occurs, the errorEvent function will be called.
        ...
        public void InitializeBillingService(Action<int, string> errorEvent, Action successEvent)
        {
            ...
            using (AndroidJavaClass pluginClass = new AndroidJavaClass(utilsClass))
            {
                if (pluginClass != null)
                {
                    ...
                    pluginUtilsClass.Call("StartIabService", bindURL, packageURL);
                    isInitializing = true;
                }
            }
        }
        ...
        /// <summary>
        /// Initializes market billing service.
        /// </summary>
        ...
        /// <summary>
        /// Loads products prices from market. If any problem occurs, the errorEvent function will be called.
        /// If everything goes well, the successEvent will be called.
        /// </summary>
        ...
        public void LoadProductPrices(Action<int, string> errorEvent, Action successEvent)
        {
            ...
            if (pluginUtilsClass != null)
            {
                if (products.Count > 0)
                {
                    ...
                    for (int i = 1; i < products.Count; i++) productIds += ("," + products[i].productId);
        ...
        /// <summary>
        /// Initiate the market flow for an in-app purchase. Call this method to initiate an in-app purchase,
        /// which will involve bringing up the market screen. The game will be paused while
        /// the user interacts with market, and the result will be delivered via errorEvent or successEvent.
        /// </summary>
        ...
        public void ConsumePurchase(Purchase purchase, Action<int, string> errorEvent, Action<Purchase, int> successEvent)
        {
        ...
        private AndroidJavaResult CheckAndroidJavaResult(string result)
        {
            ...
            {
                return new AndroidJavaResult(ERROR_INTERNAL, "the result from market is not valid.");
            }
        }

        private Purchase ParsePurchaseData(string data)
        {
            Debug.Log("PurchaseData: " + data);
        ...
        {
            string price = text.Replace("تومان", "");
            price = price.Replace(" ", "");
            price = price.Replace("٬", "");
        ...
        /// <summary>
        /// Handles purchase result from market IAB Jar library.
        ...
        /// <summary>
        /// Handles consumption result from market IAB Jar library.
        /// Don't change its name or make it private.
        /// </summary>
        ...
        /// <summary>
        /// Handles inventory check result from market IAB Jar library.
        /// Don't change its name or make it private.
        /// </summary>
        ...
        /// <summary>
        /// Handles requesting products prices result from market IAB Jar library.
        /// Don't change its name or make it private.
        /// </summary>
        ...
        /// <summary>
        /// Handles initialization result from market IAB Jar library.
        /// Don't change its name or make it private.
        /// </summary>
        ...
        /// <summary>
        /// Shows a log message from market IAB Jar library.
        /// Don't change its name or make it private.
        /// </summary>
    ...
    public class Product
    {
        ...
        public string price;
        [DrawIf("type", ProductType.Consumable)]
        public bool consumeImmidiatly;
    }
